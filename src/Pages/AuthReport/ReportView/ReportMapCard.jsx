      ...
      <div className="Rant_card_div">
        <Card className="RV_card">
          <div className="Rcard_content">
            ...
            <div style={{ display: "flex", alignItems: "center", margin: "0" }} className='rVp_mobV_userInfo'>
              <span>
                <img
          ...
          >
            ...
            erat, sed diam voluptua. At vero eos et accusam et justo d Lorem
            ipsum
          </p>
          <div className="Rcard_content">
            <div
            ...
            <div style={{ display: "flex", alignItems: "center", margin: "0" }} className='rVp_deskV_userInfo'>
              <span>
                <img
                  className="Ricon_size_responsiveuser"
                  src={userImage}
